...
<form id="login-form-<?php echo $module->id; ?>" class="mod-login" action="<?php echo Route::_('index.php', true); ?>" method="post">
    ...
    <div class="mod-login__userdata userdata">
        <div class="jl-margin">
            <?php if (!$params->get('usetext', 0)) : ?>
                <div class="jl-inline w-100">
                    <input id="modlgn-username-<?php echo $module->id; ?>" type="text" name="username" class="jl-input" autocomplete="username" placeholder="<?php echo Text::_('MOD_LOGIN_VALUE_USERNAME'); ?>">
        ...
        <div class="jl-margin">
            <?php if (!$params->get('usetext', 0)) : ?>
                <div class="jl-inline w-100">
                    <input id="modlgn-passwd-<?php echo $module->id; ?>" type="password" name="password" autocomplete="current-password" class="jl-input" placeholder="<?php echo Text::_('JGLOBAL_PASSWORD'); ?>">
